...
const de: Translations = {
  ...
  reception: { title: 'Rezeption', dashboard: 'Dashboard', housekeepingDashboard: 'Housekeeping Dashboard', filters: 'Filter', reports: 'Berichte', occupiedRooms: 'Belegt', toDo: 'Zu erledigen', urgent: 'Dringend', delays: 'Verzögerungen', departuresOfDay: 'Abreisen', confirmDeparture: 'Abreise bestätigen', confirmDepartureMsg: 'Abreise bestätigen für', noOccupiedSelected: 'Keine belegten Zimmer ausgewählt.', actionImpossible: 'Aktion unmöglich', billing: 'Abrechnung', billingAlert: 'Frühstück abzurechnen' },
