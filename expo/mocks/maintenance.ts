...
export const INITIAL_MAINTENANCE: MaintenanceTask[] = [
  {
    ...
    resolvedAt: null,
    comments: [
      { id: 'c1', author: 'Pierre D.', text: 'Pièce commandée, livraison prévue demain', date: '2026-03-28T14:00:00Z' },
    ],
    scheduleId: null,
    isPeriodic: false,
    costs: [
  ...
  },
  {
    ...
    reportedAt: '2026-03-28T07:30:00Z',
    priority: 'haute',
    status: 'en_attente',
    assignedTo: null,
    photos: [],
  ...
  },
  {
    ...
    reportedBy: 'Sophie Martin',
    reportedAt: '2026-03-28T09:00:00Z',
    priority: 'basse',
    status: 'en_attente',
    assignedTo: null,
    photos: [],
  ...
  },
  {
    ...
    reportedAt: '2026-03-27T16:00:00Z',
    priority: 'moyenne',
    status: 'resolu',
    assignedTo: 'Luc B.',
    photos: [],
    resolutionNotes: 'Serrure remplacée et testée avec succès.',
    resolvedAt: '2026-03-27T18:00:00Z',
    comments: [
      { id: 'c4', author: 'Luc B.', text: 'Serrure changée, carte testée OK', date: '2026-03-27T18:00:00Z' },
    ],
    scheduleId: null,
    isPeriodic: false,
    costs: [
  ...
  },
  {
    ...
    reportedAt: '2026-03-27T08:15:00Z',
    priority: 'moyenne',
    status: 'en_attente',
    assignedTo: null,
    photos: [],
  ...
  },
  {
    ...
    resolvedAt: '2026-03-26T14:30:00Z',
    comments: [],
    scheduleId: 'ms5',
    isPeriodic: true,
    costs: [
  ...
  },
  {
    ...
    roomNumber: '105',
    title: 'Fuite douche',
    description: 'Eau qui s\'infiltre sous la porte de la salle de bain pendant la douche.',
    reportedBy: 'Sophie Martin',
    reportedAt: '2026-03-25T11:30:00Z',
    priority: 'haute',
    status: 'en_attente',
    assignedTo: null,
    photos: [],
  ...
  },
  {
    ...
    description: 'La poignée de la fenêtre côté rue est cassée, fenêtre ne ferme plus.',
    reportedBy: 'Marie Dupont',
    reportedAt: '2026-03-25T14:00:00Z',
    priority: 'moyenne',
    status: 'resolu',
    assignedTo: 'Luc B.',
    photos: [],
    resolutionNotes: 'Poignée remplacée.',
    resolvedAt: '2026-03-25T17:00:00Z',
    comments: [],
    scheduleId: null,
    isPeriodic: false,
    costs: [],
