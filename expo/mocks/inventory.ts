...
export const INITIAL_LOST_FOUND: LostFoundItem[] = [
  ...
  },
  {
    ...
    foundDate: '2026-02-10',
    status: 'consigne',
    returnedTo: '',
    returnedDate: '',
    consignedDate: '2026-03-15',
    consignedLocation: 'Bureau A12, Armoire 3',
    consignedObservations: 'Aucune réclamation après 1 mois',
  },
  {
    id: 'lf7',
    roomId: '8',
