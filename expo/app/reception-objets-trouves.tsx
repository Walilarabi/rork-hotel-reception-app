...
const s = StyleSheet.create({
  ...
  formModalCard: { borderRadius: 20, maxHeight: '80%', overflow: 'hidden' },
  formModalCardTall: { maxHeight: '90%' },
  formModalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1 },
  formModalTitle: { fontSize: 16, fontWeight: '700' as const },
  formModalBody: { paddingHorizontal: 20, paddingVertical: 16 },
  formItemSummary: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 12, borderWidth: 1, marginBottom: 16 },
  ...
  formInput: { fontSize: 14, paddingHorizontal: 14, paddingVertical: 12, borderRadius: 10, borderWidth: 1 },
