...
const de: Translations = {
  ...
  roles: { super_admin: 'Super Admin', direction: 'Direktion', reception: 'Rezeption', gouvernante: 'Hausdame', femme_de_chambre: 'Zimmermädchen', maintenance: 'Wartung', breakfast: 'Frühstück', support: 'Support', spa: 'SPA' },
  ...
  fileImport: { title: 'Dateiimport', importFile: 'Datei importieren', importReservations: 'Reservierungen importieren', selectFile: 'Datei auswählen', dragDrop: 'Datei hierhin ziehen oder klicken', supportedFormats: 'Unterstützte Formate: CSV', step1SelectFile: 'Datei auswählen', step2MapColumns: 'Spalten zuordnen', step3Preview: 'Vorschau & Validierung', step4Result: 'Ergebnis', fileSelected: 'Datei ausgewählt', fileSize: 'Größe', columnMapping: 'Spaltenzuordnung', guestName: 'Gastname', checkInDate: 'Check-in Datum', checkOutDate: 'Check-out Datum', roomNumber: 'Zimmernummer', adults: 'Erwachsene', children: 'Kinder', preferences: 'Präferenzen', breakfastIncluded: 'Frühstück inklusive', selectColumn: 'Spalte auswählen', dateFormat: 'Datumsformat', preview: 'Vorschau', previewDesc: 'Erkannte Reservierungen vor dem Import prüfen', linesDetected: 'Reservierung(en) erkannt', duplicateHandling: 'Duplikatbehandlung', ignore: 'Ignorieren', replace: 'Ersetzen', merge: 'Zusammenführen', importBtn: 'Importieren', importing: 'Wird importiert...', importSuccess: 'Import erfolgreich abgeschlossen', importPartial: 'Teilimport', importFailed: 'Import fehlgeschlagen', reservationsImported: 'Reservierung(en) importiert', linesIgnored: 'Zeile(n) ignoriert', roomNotFound: 'Zimmer nicht gefunden', invalidDate: 'Ungültiges Datum', missingRequired: 'Pflichtfeld fehlt', downloadErrorReport: 'Fehlerbericht herunterladen', viewReservations: 'Reservierungen anzeigen', manualEntry: 'Manuelle Eingabe', manualEntryDesc: 'Reservierungen manuell hinzufügen', addRow: 'Zeile hinzufügen', removeRow: 'Entfernen', noFileSelected: 'Keine Datei ausgewählt', parseError: 'Fehler beim Lesen der Datei', noPms: 'Manueller Import (ohne PMS)', noPmsDesc: 'Importieren Sie Reservierungen aus einer CSV-Datei oder geben Sie sie manuell ein', separator: 'Trennzeichen', autoDetect: 'Automatisch erkennen', column: 'Spalte', optional: 'Optional', required: 'Erforderlich' },
};
...
const es: Translations = {
  ...
  roles: { super_admin: 'Super Admin', direction: 'Dirección', reception: 'Recepción', gouvernante: 'Gobernanta', femme_de_chambre: 'Camarera de piso', maintenance: 'Mantenimiento', breakfast: 'Desayuno', support: 'Soporte', spa: 'SPA' },
...
const it: Translations = {
  ...
  roles: { super_admin: 'Super Admin', direction: 'Direzione', reception: 'Ricevimento', gouvernante: 'Governante', femme_de_chambre: 'Cameriera ai piani', maintenance: 'Manutenzione', breakfast: 'Colazione', support: 'Supporto', spa: 'SPA' },
...
const pt: Translations = {
  ...
  roles: { super_admin: 'Super Admin', direction: 'Direção', reception: 'Receção', gouvernante: 'Governanta', femme_de_chambre: 'Empregada de andares', maintenance: 'Manutenção', breakfast: 'Pequeno-almoço', support: 'Suporte', spa: 'SPA' },
...
const ar: Translations = {
  ...
  roles: { super_admin: 'المدير العام', direction: 'الإدارة', reception: 'الاستقبال', gouvernante: 'المشرفة', femme_de_chambre: 'عاملة النظافة', maintenance: 'الصيانة', breakfast: 'الإفطار', support: 'الدعم', spa: 'سبا' },
